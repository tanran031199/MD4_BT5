create schema if not exists BaiTap4;
...
delimiter //
create procedure delProduct(inputName varchar(45))
begin
    delete from OrderDetails where pID = (select pID from Products where pName = inputName);
    delete from Products where pName = inputName;
end //
delimiter ;
